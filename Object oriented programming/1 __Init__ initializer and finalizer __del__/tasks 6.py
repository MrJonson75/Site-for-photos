'''
        ...
        Обратите внимание при создании объекта класса MotherBoard можно передавать несколько объектов
        класса Memory, максимум N - по числу слотов памяти на материнской плате (N = 4).
        ...
        mem_slots - список из объектов класса Memory
...
class MotherBoard:
    def __init__(self, name, cp, *args):
        self.name = name
        self.cpu = cp
        ...
        if len(args) <= 4:
            ...
            raise ValueError("Неверное количество слотов")
...
cpu = CPU('Intel', 4000)
volume1 = Memory('KingSton', 16)
volume2 = Memory('KingSton', 16)


try:
    mb = MotherBoard('Asus', cpu, volume1, volume2)
    print(mb.get_config())
