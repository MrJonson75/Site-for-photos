...
* Создаёт `logs/app.log`
* Когда файл достигает **5 МБ**, он переименовывается в `app.log.1`, затем `app.log.2` и т. д.
* Хранится до **5 предыдущих логов** + текущий
